...
export default function ProjectMarketDevelopment() {
                                ...
                                {(Array.isArray(stages) ? stages : []).map((stage: Stage, index: number) => (
                                    <Box
                                        ...
                                        sx={{
                                            ...
                                            alignItems: "center",
                                            gap: 1,
                                            bgcolor: selectedStageIndex === index ? "#fff7ed" : "transparent",
                                            cursor: "pointer",
                                        }}
                                    >
                                        <Chip
                                        ...
                                        <Typography
                                            sx={{
                                                fontSize: "14px",
                                                fontWeight: 600,
                                                color: selectedStageIndex === index ? "#F4A62A" : "text.primary",
                                            }}
                                        >
                                            {stage?.name}
                                        </Typography>
