...
export default function PulicPrivateAuthLogin() {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { resetForm, setSubmitting }) => {
            try {
                const res = await CMSservice.PublicPrivateLogin(values)
            ...
            >
                ...
                >
                    <Box>
                        ...
                        >
                            Welcome to Sourceseas Public or Private Personnel Portal
                        </Typography>
                    ...
                    <Stack spacing={2.2} sx={{ mt: 5 }}>
                        <Box sx={{ display: "flex", gap: 1.5, alignItems: "center" }}>
                            ...
                            <Typography variant="body2">
                                Verified Public or Private Personnel network for safe sourcing
                            </Typography>
                        </Box>
                ...
                >
                    <Box sx={{ width: "100%", maxWidth: 420 }}>
                        ...
                        >
                            ...
                            >
                                Public or Private Personnel Login
                            </Typography>
                            ...
                            <Typography
                                ...
                                sx={{ mt: 1.2, mb: 3 }}
                            >
                                Enter your email and password to access your Public or Private Personnel dashboard.
                            </Typography>
                            ...
                            <Box component="form" onSubmit={formik.handleSubmit} noValidate>
                                ...
                                >
                                    <Button
                                        size="small"
                                        onClick={() => navigate("/forgot-password", { state: { role: 'career' } })}
                                        sx={{
                                            textTransform: "none",
                                            fontWeight: 600,
                                        }}
                                ...
                                <Box sx={{ textAlign: "center" }}>
                                    <Typography variant="body2" color="text.secondary">
                                        Create your Public or Private Personnel account and start sourcing smarter.
                                    </Typography>
                                    ...
                                    >
                                        Create Public or Private Personnel Account
                                    </Button>
                                </Box>
                            </Box>
                        </Paper>
