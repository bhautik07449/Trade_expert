...
export default function LoginForm() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm, setSubmitting }) => {
      try {
        const res = await Investorservice.investorLogin(values)
      ...
      >
        ...
        >
          <Box>
            ...
            >
              Welcome to Sourceseas Investor Portal
            </Typography>
            ...
            >
              Sign in to manage your trading requirements, connect with trusted
              businesses, track deals, and discover investment opportunities.
            </Typography>
          </Box>
          ...
          <Stack spacing={2.2} sx={{ mt: 5 }}>
            <Box sx={{ display: "flex", gap: 1.5, alignItems: "center" }}>
              ...
              <Typography variant="body2">
                Verified network for safe trading
              </Typography>
            </Box>
            ...
            <Box sx={{ display: "flex", gap: 1.5, alignItems: "center" }}>
              <ShoppingBagIcon />
              <Typography variant="body2">
                Explore categories, deals, and investment opportunities
              </Typography>
            </Box>
          </Stack>
        </Box>
            ...
            >
              ...
              <Box component="form" onSubmit={formik.handleSubmit} noValidate>
                ...
                >
                  <Button
                    size="small"
                    onClick={() => navigate("/forgot-password", { state: { role: 'investor' } })}
                    sx={{
                      textTransform: "none",
                      fontWeight: 600,
                    }}
                ...
                <Box sx={{ textAlign: "center" }}>
                  <Typography variant="body2" color="text.secondary">
                    Create your investor account and start trading smarter.
                  </Typography>
