...
export default function InlineEnquiryForm({ product }: Props) {
    ...
    const validationSchema = Yup.object({
        ...
        requirementFrequency: Yup.string().required(
            "Requirement frequency is required"
        ),
        ...
        website: Yup.string().trim().url("Enter valid URL").nullable().notRequired(),
                        ...
                        <Grid container spacing={2} mt={1}>
                            ...
                            <Grid size={{ xs: 12, md: 6 }}>
                                <TextField
                                    ...
                                    onChange={formik.handleChange}
                                    error={
                                        formik.touched.expectedQty &&
                                        Boolean(formik.errors.expectedQty)
                                    }
                                    helperText={
                                        formik.touched.expectedQty &&
                                        formik.errors.expectedQty
                                    }
                                />
                            </Grid>
                        </Grid>
                        ...
                        <Grid container spacing={2} mt={1}>
                            ...
                            <Grid size={{ xs: 12, md: 6 }}>
                                <TextField
                                    ...
                                    onChange={formik.handleChange}
                                    error={
                                        formik.touched.preferredPrice &&
                                        Boolean(formik.errors.preferredPrice)
                                    }
                                    helperText={
                                        formik.touched.preferredPrice &&
                                        formik.errors.preferredPrice
                                    }
                                />
                            </Grid>
                        </Grid>
...
function ContactFields({ formik }: any) {
    return (
        <>
            <Typography fontWeight={700} mb={2}>
                Contact Detail
